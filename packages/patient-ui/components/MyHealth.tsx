...
import { HealthProfile, UserExam, Notification } from '../../shared/types';
...
const MyHealth: React.FC<MyHealthProps> = ({ user, onUpdateHealth, onAddNotif }) => {
  ...
  const [exams, setExams] = useState<UserExam[]>([
    { id: 'e1', name: 'Hemograma Completo', date: '12/05/2024', laboratory: 'LabVita', category: 'Sangue', url: '#' },
    { id: 'e2', name: 'Check-up Hormonal', date: '10/02/2024', laboratory: 'A+ Medicina', category: 'Hormônios', url: '#' }
  ]);
