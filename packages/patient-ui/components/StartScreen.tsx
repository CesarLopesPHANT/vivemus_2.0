...
import { UserData, View } from '../../shared/types';
import { Partner } from '../../shared/types';
import { PatientSectionsConfig } from './MobilePatientApp';
  ...
  const allBanners = [
    {
      ...
      desc: "Médicos de plantão agora mesmo para você e sua família.",
      btn: "Iniciar Agora",
      color: "from-[#00D8FF] to-[#00A3FF]",
      icon: Video,
      action: () => onSelect('consultation'),
      sectionKey: 'consultation' as keyof PatientSectionsConfig
    },
    {
  ...
  return (
    <div className="space-y-6 pb-8">
      ...
      <div className="grid grid-cols-2 gap-3">
        {[
          { id: 'consultation', title: 'Consultas', desc: 'Falar com médico', icon: Stethoscope, color: 'bg-[#00D8FF]' },
      ...
      {/* Recurso: Status de Saúde - Mobile */}
      {sectionConfig?.health !== false && <section className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm">
        ...
        <div className="space-y-3">
           ...
           <div className="p-3 bg-slate-50 rounded-xl flex items-center justify-between">
              <div className="flex items-center gap-3">
                 <div className="w-8 h-8 bg-blue-100 text-blue-600 rounded-lg flex items-center justify-center"><Droplets size={16}/></div>
                 <div>
                    <p className="text-[9px] font-bold text-slate-400 uppercase">Hidratação</p>
                    <p className="text-xs font-black text-slate-800">1.250 / 2.000 ml</p>
                 </div>
              </div>
           ...
           <div className="p-3 bg-slate-50 rounded-xl flex items-center justify-between">
              <div className="flex items-center gap-3">
                 <div className="w-8 h-8 bg-emerald-100 text-emerald-600 rounded-lg flex items-center justify-center"><Footprints size={16}/></div>
                 <div>
                    <p className="text-[9px] font-bold text-slate-400 uppercase">Atividade</p>
                    <p className="text-xs font-black text-slate-800">3.400 / 5.000 passos</p>
                 </div>
              </div>
              <div className="w-12 h-1.5 bg-slate-200 rounded-full overflow-hidden">
      ...
      {sectionConfig?.partners !== false && <section className="space-y-4">
        <div className="flex items-center justify-between">
           <h3 className="text-sm font-black text-slate-800 flex items-center gap-2">
